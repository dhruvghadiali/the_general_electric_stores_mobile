        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              AppTextField(
                label: 'Stocks',
                hint: 'How many units are arriving?',
                helper: 'Between ${StockLimits.min} and ${StockLimits.max}.',
                controller: controller.stocksInput,
                prefixIcon: Icons.numbers_rounded,
                keyboardType: const TextInputType.numberWithOptions(),
                textInputAction: TextInputAction.done,
                // Digits only at the keyboard, so a minus sign, a decimal point
                // or a seventh digit never reaches the validator in the first
                // place. The validator still owns the range — a formatter can
                // cap the length but not the value.
                inputFormatters: <TextInputFormatter>[
                  FilteringTextInputFormatter.digitsOnly,
                  LengthLimitingTextInputFormatter(StockLimits.maxDigits),
                ],
                validator: validateStocks,
                // Revalidate as the number is edited, so the message clears the
                // moment the value becomes good rather than at submit time.
